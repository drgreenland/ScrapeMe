...
class SMHScraper(BaseScraper):
    """Scraper for Sydney Morning Herald NRL news."""

    def get_article_urls(self) -> list[dict]:
        """Get article URLs from SMH NRL section."""
        ...
        # SMH uses Nine network patterns
        selectors = [
    ...
    def parse_article(self, url: str, html: str) -> Optional[dict]:
        ...
        # Summary/standfirst - SMH often has paywall
